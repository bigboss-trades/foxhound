...
# untagged (virgin) POC, VAL, and VAH. This study has a setting to toggle
# between Market Profile (TPOProfile) and Volume Profile.
#
...
input mode = {default Market, Volume};
